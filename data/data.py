...
def compute_covariance_matrix(expected_revenue: np.ndarray,
    ...
    """
    Construct a diagonal covariance matrix using risk proxy
    """
    variance = (expected_revenue * risk) ** 2
...
def compute_risk_contribution(weights, cov_matrix):
    ...
    return weights * marginal / portfolio_risk if portfolio_risk > 0 else np.zeros_like(weights)
